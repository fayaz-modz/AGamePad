...
class BluetoothStatusCard extends GetView<ConnectionController> {
  const BluetoothStatusCard({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final isAdvertising = controller.isAdvertising;
      final isConnected = controller.isConnected;
      final deviceAddress = controller.connectedDeviceAddress;
